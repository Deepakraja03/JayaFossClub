          ...
          <div className="mx-auto  max-w-4xl  py-10 sm:pt-20 lg:pt-16">
            ...
            <div className="text-center">
              ...
              <p className="mt-6 text-lg leading-8  text-gray-500">
                ...
                participants. We create awareness and importance of Free and
                Open Source Software among student and industry people.
              </p>
            ...
            <div className="text-center pt-16">
              ...
              <div className="mt-6 text-lg leading-8 text-gray-300 flex items-center justify-center">
                <BsRocketTakeoff className="h-4 w-auto" />
                <p className="ml-2">
                  Modifying the program in its source code form entails
                  analyzing and editing its codebase.
                </p>
              </div>
              <div className="mt-6 text-lg leading-8 text-gray-300 flex items-center justify-center">
                <BsRocketTakeoff className="h-4 w-auto" />
                <p className="ml-2">
                  Distributing modified versions refers to propagating
                  variations of the program with changes.
                </p>
              </div>
